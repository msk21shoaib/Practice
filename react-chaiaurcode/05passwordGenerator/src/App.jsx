      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500">
        ...
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          <input
            ...
            readOnly
            ref={passwordRef} //passed the reference of password
          />
          <button
        ...
        <div className="flex text-sm gap-x-2">
          <div className="flex items-center gap-x-1">
            <input
              ...
              max={100}
              value={length}
              className="cursor-pointer" //type of button
              onChange={(e) => {
          ...
          <div className="flex items-center gap-x-1">
            <input
              ...
              id="numberInput"
              onChange={() => {
                setNumberAllowed((prev) => !prev); //true to false
              }}
            />
...
(kuch bhi chhedchhad ho to dobara se run krdo)
